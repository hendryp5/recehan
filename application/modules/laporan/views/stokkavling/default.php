...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="box-body">
                <a class="btn btn-sm btn-flat btn-primary" onclick="print()" href="<?= site_url('laporan/stokkavling/cetak'); ?>"><i class="glyphicon glyphicon-print"></i> Print</a>
                <button class="btn btn-sm btn-flat btn-success" data-toggle="tooltip" title="Reload Data" data-placement="right" id="btn-reset"><i class="glyphicon glyphicon-refresh"></i></button>
