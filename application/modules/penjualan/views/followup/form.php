...
<div id="page-wrapper">
    ...
    <br>
            ...
            <ul>
                ...
                <li><a href="#follow">Langkah 2<br /><small>Follow up</small></a></li>
            </ul>
            <br>
            <div>
                <div id="data">
                    <div class="row">
                        ...
                        <div class="form-group <?php echo form_error('nama') ? 'has-error' : null; ?>">
                            ...
                            $data = array('class'=>'form-control','name'=>'nama','id'=>'nama','type'=>'text','placeholder'=>'Masukkan Nama Nasabah Followup','autocomplete'=>'off','value'=>set_value('kode', $record->nama));
                    ...
                    <div class="col-md-12">
                        <div class="form-group <?php echo form_error('pekerjaan') ? 'has-error' : null; ?>">
                            ...
                            echo form_dropdown('pekerjaan', $group_pkj, $selected, "class='form-control select2' style='width: 100%;' name='pekerjaan' id='pekerjaan'");
                ...
                <div id="follow">
                    <div class="row">
                        ...
                        <div class="form-group <?php echo form_error('tanggal') ? 'has-error' : null; ?>">
                            ...
                            $data = array('class'=>'form-control','name'=>'tanggal','id'=>'tanggal','type'=>'text','placeholder'=>'Masukkan Tanggal','value'=>set_value('tanggal', $record->tanggal));
                            echo form_input($data);
                    ...
                    <div class="col-md-12">
                        <div class="form-group <?php echo form_error('melalui') ? 'has-error' : null; ?>">
                            ...
                            $selected = set_value('melalui', $record->melalui);
                            $status = array('0'=>'Pilih Melalui Apa?','1'=>'TELEPON','2'=>'BERTEMU','3'=>'KEKANTOR','4'=>'KELOKASI','5'=>'CLOSING/PESAN UNIT');
                            echo form_dropdown('melalui', $status, $selected, "class='form-control select2' style='width: 100%;' name='melalui' id='melalui'");
                     ...
                     <div class="col-md-12">
                        <div class="form-group <?php echo form_error('keterangan') ? 'has-error' : null; ?>">
                            ...
                            $data = array('class'=>'form-control','name'=>'keterangan','id'=>'keterangan','type'=>'text','placeholder'=>'Masukkan Keterangan','value'=>set_value('keterangan', $record->keterangan));
                            echo form_textarea($data);
                    ...
                    <div class="col-md-12">
                        <div class="form-group <?php echo form_error('hasil') ? 'has-error' : null; ?>">
                            ...
                            $selected = set_value('hasil', $record->hasil);
                            $status = array('0'=>'--KESIMPULAN--','1'=>'Belum Berminat','2'=>'Pikir-pikir','3'=>'Berminat','4'=>'Deal');
                            echo form_dropdown('hasil', $status, $selected, "class='form-control select2' style='width: 100%;' name='hasil' id='hasil'");
