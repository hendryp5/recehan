...
<div id="page-wrapper">
    ...
    <input type="hidden" name="kavling_idx" id="kavling_idx" value="<?= set_value('kavling_idx', $record->kavling_id); ?>"/>
            ...
            <div class="box-footer">
               <a class="btn btn-flat btn-default btn-sm" href="<?php echo site_url('penjualan/pesanunit')?>"  title="Keluar"><i class="fa fa-arrow-left"></i> KEMBALI</a>
              <a class="btn btn-flat btn-warning btn-sm" onclick="edit_data();" href="<?php echo site_url('penjualan/pesanunit/updated/'.$record->id)?>" data-toggle="tooltip" title="Ubah Data"><i class="fa fa-edit"></i> Ubah</a>
                <a class="btn btn-flat btn-danger btn-sm" href="<?php echo site_url('penjualan/pesanunit/deleted/'.$record->id) ?>" data-toggle="tooltip" title="Hapus"><i class="fa fa-trash"></i> Hapus</a>
            </div>
        </div>
        <!-- /.row -->
    </div>
