	...
	<div class="col-md-12">
		...
		<div class="box box-success box-solid">
			...
			<div class="box-body">
				<div class="row">
					<div class="col-md-12">
						<a class="btn btn-sm btn-flat btn-success" onclick="add_data();" href="<?= site_url('pengaturan/kategorirab/created'); ?>"><i class="glyphicon glyphicon-plus"></i> Tambah Data</a>
