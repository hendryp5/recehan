				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group <?php echo form_error('kode') ? 'has-error' : null; ?>">
							<?php
							echo form_label('KODE KATEGORI','kode');
					...
					<div class="col-md-12">
						<div class="form-group <?php echo form_error('kategori') ? 'has-error' : null; ?>">
							...
							$data = array('class'=>'form-control','name'=>'kategori','id'=>'kategori','type'=>'text','value'=>set_value('kategori', $record->kategori));
							echo form_input($data);
					...
					<div class="col-md-12">
						<div class="form-group <?php echo form_error('parent_id') ? 'has-error' : null; ?>">
							<?php 
							echo form_label('KATEGORI UTAMA','parent_id');
							$selected = set_value('parent_id', $record->parent_id);
							echo form_dropdown('parent_id', $group, $selected, "class='form-control select2' name='parent_id' id='parent_id'");
