...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="box-body">
                <a class="btn btn-sm btn-flat btn-success" onclick="add_data();" href="<?= site_url('penjualan/daftarkavling/created'); ?>"><i class="glyphicon glyphicon-plus"></i> Tambah Data</a>
