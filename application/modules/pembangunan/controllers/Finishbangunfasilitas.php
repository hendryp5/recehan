...
class Finishbangunfasilitas extends CI_Controller {
	/**
	 * code by rifqie rusyadi
	 * email rifqie.rusyadi@gmail.com
	 */
	public $folder = 'pembangunan/finishpembangunan/finishbangunfasilitas/';
	
	public function __construct()
	{
		parent::__construct();
		$this->load->model('Finishbangunfasilitas_m', 'data');
	...
	{
		$data['judul'] 		= 'Finish Pembangunan Fasilitas';
