...
class Progresfasilitas extends CI_Controller {
	/**
	 * code by rifqie rusyadi
	 * email rifqie.rusyadi@gmail.com
	 */
	public $folder = 'pembangunan/progrespembangunan/progresfasilitas/';
	
	public function __construct()
	{
		parent::__construct();
		$this->load->model('Progresfasilitas_m', 'data');
	...
	{
		$data['judul'] 		= 'Progres Pembangunan Fasilitas';
