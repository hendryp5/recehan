...
class Kontrakbangunfasilitas extends CI_Controller {
	/**
	 * code by rifqie rusyadi
	 * email rifqie.rusyadi@gmail.com
	 */
	public $folder = 'pembangunan/kontrakpembangunan/kontrakbangunfasilitas/';
	
	public function __construct()
	{
		parent::__construct();
		$this->load->model('Kontrakbangunfasilitas_m', 'data');
	...
	{
		$data['judul'] 		= 'Kontrak Bangun Fasilitas';
