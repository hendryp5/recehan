...
class Finishbangunrumah extends CI_Controller {
	/**
	 * code by rifqie rusyadi
	 * email rifqie.rusyadi@gmail.com
	 */
	public $folder = 'pembangunan/finishpembangunan/finishbangunrumah/';
	
	public function __construct()
	{
		parent::__construct();
		$this->load->model('Finishbangunrumah_m', 'data');
	...
	{
		$data['judul'] 		= 'Finish Pembangunan Rumah';
		$data['head'] 		= 'KPR';
