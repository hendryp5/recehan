...
class Progresrumah extends CI_Controller {
	/**
	 * code by rifqie rusyadi
	 * email rifqie.rusyadi@gmail.com
	 */
	public $folder = 'pembangunan/progrespembangunan/progresrumah/';
	
	public function __construct()
	{
		parent::__construct();
		$this->load->model('Progresrumah_m', 'data');
	...
	{
		$data['judul'] 		= 'Progres Pembangunan Rumah';
		$data['head'] 		= 'KPR';
