...
class Kontrakbangunrumah extends CI_Controller {
	/**
	 * code by rifqie rusyadi
	 * email rifqie.rusyadi@gmail.com
	 */
	public $folder = 'pembangunan/kontrakpembangunan/kontrakbangunrumah/';
	
	public function __construct()
	{
		parent::__construct();
		$this->load->model('Kontrakbangunrumah_m', 'data');
	...
	{
		$data['judul'] 		= 'Kontrak Bangun Rumah';
		$data['head'] 		= 'KPR';
